...
import {
  Рисунок1, Рисунок2, Рисунок3, Рисунок4, Рисунок10, Рисунок11,
  Рисунок12, Рисунок13, Рисунок14, Рисунок15, Рисунок16, Рисунок17, Рисунок18, Рисунок19, Рисунок20, Рисунок21, Рисунок22, Рисунок23, Рисунок24, Рисунок25, Рисунок26, Рисунок30, Рисунок31
} from '../assets/articleimage';
      ...
      if (token) {
        ...
        if (currentUserID && isRead) {
          ...
          const urlParams = new URLSearchParams({
            total_points: points + 200 * readArticles
          })

          response = await fetch(`/api/users/${localStorage.getItem("id")}?${urlParams}`, {
            method: "PUT",
            headers: {
